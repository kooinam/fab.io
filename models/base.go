...
// Instantiate used for setting up base attributes for a mongo record
func (base *Base) Instantiate(collection *Collection, hooksHandler *HooksHandler, item Modellable) {
